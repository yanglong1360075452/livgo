package com.livgo.app.mq.service;

import com.livgo.app.mq.Json.JSONArray;
import com.livgo.app.mq.Json.JSONObject;
...
public class Queue{
	 ...
	 * @throws CMQServerException
	 */
	public Message receiveMessage(int pollingWaitSeconds,String username) throws Exception {
		TreeMap<String, String> param = new TreeMap<String, String>();

	    param.put("queueName",username);
	 ...
	 * @throws CMQServerException
	 */
	public List<Message> batchReceiveMessage(int numOfMsg, int pollingWaitSeconds,String username) throws Exception {
		TreeMap<String, String> param = new TreeMap<String, String>();
